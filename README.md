...
A demo application that manages drawing canvases via websockets. The frontend to this app is hosted [here on Cloudfront](http://d1kzdlgex69htr.cloudfront.net/random) - source repo [here](https://github.com/JFL110/spring-websockets-example-frontend)
